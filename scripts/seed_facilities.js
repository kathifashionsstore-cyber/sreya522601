...
const fallbackFacilities = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1579156286657-41d3d68aa0a9?auto=format&fit=crop&w=800&q=80",
    images: [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1581093458791-9d2fcea0a349?auto=format&fit=crop&w=800&q=80",
    images: [
...
async function run() {
  console.log('Restoring all 10 facilities (clearing deletedAt)...');
  for (const f of fallbackFacilities) {
    ...
    console.log(`Restored active state for ${id} (${f.title})`);
  }
  console.log('Finished restoring 10 facilities.');
}
