export const doctors = [
  {
    ...
    awards: [
      "Pioneered the delivery of the first test-tube baby in the Narasaraopet region.",
      "7+ years leading Sreya Hospitals & IVF Centre with high clinical success rates."
    ],
    memberships: [
