...
export const heroSlides = [
  {
    ...
    altText: 'Fertility consultation room image',
    badgeText: 'First IVF Centre in Palnadu',
    title: 'Your journey to parenthood, guided with care',
    subtitle: 'Advanced fertility and women\'s health care led by Dr. M. Vasanta Kiran in Narasaraopet.',
  ...
  },
  {
    ...
    altText: 'Fertility testing consultation image',
    badgeText: 'Fertility Testing & Diagnostics',
    title: 'Clear answers before treatment begins',
    subtitle: 'From hormone profiles and scans to semen analysis and partner screening, the team keeps couples informed before treatment decisions.',
  ...
  {
    id: 'hero-slide-3',
    imageUrl: 'https://images.unsplash.com/photo-1584515933487-779824d29309?auto=format&fit=crop&w=1600&q=80',
    altText: 'Advanced embryology laboratory image',
    badgeText: 'State-of-the-Art Facilities',
    title: 'Advanced Embryology & IVF Laboratory',
    subtitle: 'Ultra-clean laminar flow cabinets, CO2 incubators, and precision ICSI micro-manipulation for high success rates.',
  ...
  },
  {
    ...
    altText: 'Gynecological surgical room image',
    badgeText: 'Specialized Women\'s Health',
    title: 'Comprehensive Gynecological & Surgical Care',
    subtitle: 'Laparoscopic and hysteroscopic procedures performing keyhole surgeries with faster recovery and minimal hospital stay.',
    ctaText: 'View Treatments',
    ctaLink: '/services/fertility-treatments',
  ...
  },
  {
    ...
    altText: 'Doctor patient consultation image',
    badgeText: 'Experienced Clinical Leadership',
    title: '17+ Years of Trusted Parenthood Journeys',
    subtitle: 'Over 2,000+ happy families guided through personalized, compassionate fertility protocols.',
